...
- (DUMB DON'T DO) Add a simulation feature that can run a simulation of the app trying diffrent thread amounts to find the ideal pool for the given machine. "Not worth it probrbly and should be something that the developer should do".
